...
ActiveRecord::Schema.define(version: 20161014184604) do
  ...
  create_table "soldados", force: :cascade do |t|
    t.string   "nome"
  ...
  add_index "soldados", ["patente_id"], name: "index_soldados_on_patente_id"
